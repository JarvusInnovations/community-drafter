...
- The operator digest (§ Operator digest) runs once daily at a configured hour in the instance time zone. It is the only scheduled sender; nothing scheduled ever mails a participant.
