...
export const BUNDLE_OUTFILE = join(REPO_ROOT, "skills/drafter-axi/scripts/drafter-axi.mjs");
export const SKILL_MD_PATH = join(REPO_ROOT, "skills/drafter-axi/SKILL.md");
